...
export function ConnectPlatformsSection({ onConnectPlatform }: ConnectPlatformsSectionProps) {
  ...
  const TikTokIcon = (
    <svg 
      className="h-8 w-8 social-icon social-icon-tiktok"
      xmlns="http://www.w3.org/2000/svg" 
      viewBox="0 0 24 24" 
      fill="currentColor"
    >
  ...
  const WhatsAppIcon = (
    <svg 
      className="h-8 w-8 social-icon social-icon-whatsapp"
      xmlns="http://www.w3.org/2000/svg" 
      viewBox="0 0 24 24" 
      fill="currentColor"
    >
  ...
  const YelpIcon = (
    <svg 
      className="h-8 w-8 social-icon social-icon-yelp"
      xmlns="http://www.w3.org/2000/svg" 
      viewBox="0 0 24 24" 
      fill="currentColor"
    >
  ...
  return (
    <div className="grid gap-4 md:grid-cols-3 lg:grid-cols-4">
      ...
      <ConnectPlatformCard
        title="TikTok"
        icon={TikTokIcon}
        description="Connect your TikTok account to monitor and respond to comments on your videos."
        features={[
          "Reply to comments on your TikTok videos",
      ...
      <ConnectPlatformCard
        title="YouTube"
        icon={<Youtube className="h-8 w-8 social-icon social-icon-youtube" />}
        description="Connect your YouTube channel to manage and respond to comments on your videos."
        features={[
      ...
      <ConnectPlatformCard
        title="LinkedIn"
        icon={<Linkedin className="h-8 w-8 social-icon social-icon-linkedin" />}
        description="Connect your LinkedIn profile or page to monitor and respond to comments on your posts."
        features={[
          "Manage comments on professional content",
      ...
      <ConnectPlatformCard
        title="Yelp"
        icon={YelpIcon}
        description="Connect your Yelp business page to monitor and respond to customer reviews."
        features={[
